...
public class YenController implements Initializable {
    ...
    @FXML
    private ImageView yenImageView1, yenImageView2, yenImageView3;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        price.setText(String.valueOf(MainPageController.yenPrice));
        change.setText(MainPageController.changes.get(3));
        min.setText(MainPageController.totalMin.get(3));
        max.setText(MainPageController.totalMax.get(3));
        ...
        translateTransitionCoin1.setNode(yenImageView1);
        ...
        translateTransitionCoin2.setNode(yenImageView2);
        ...
        translateTransitionCoin3.setNode(yenImageView3);
