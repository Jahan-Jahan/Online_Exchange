...
public class DollarController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        price.setText(String.valueOf(MainPageController.dollarPrice));
        change.setText(MainPageController.changes.getFirst());
        min.setText(MainPageController.totalMin.getFirst());
        max.setText(MainPageController.totalMax.getFirst());
