...
public class TomanController implements Initializable {
    ...
    @FXML
    private ImageView tomanImageView1, tomanImageView2, tomanImageView3;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        price.setText(String.valueOf(MainPageController.tomanPrice));
        change.setText(MainPageController.changes.get(2));
        min.setText(MainPageController.totalMin.get(2));
        max.setText(MainPageController.totalMax.get(2));
        ...
        translateTransitionCoin1.setNode(tomanImageView1);
        ...
        translateTransitionCoin2.setNode(tomanImageView2);
        ...
        translateTransitionCoin3.setNode(tomanImageView3);
